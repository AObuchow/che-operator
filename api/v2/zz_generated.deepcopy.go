...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PerUserStrategyPvcConfig) DeepCopyInto(out *PerUserStrategyPvcConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PerUserStrategyPvcConfig.
func (in *PerUserStrategyPvcConfig) DeepCopy() *PerUserStrategyPvcConfig {
	if in == nil {
		return nil
	}
	out := new(PerUserStrategyPvcConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkspaceStorage) DeepCopyInto(out *WorkspaceStorage) {
	*out = *in
	out.PerUserStrategyPvcConfig = in.PerUserStrategyPvcConfig
}
